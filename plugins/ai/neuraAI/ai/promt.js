...
Inget: ${memoryNote}
Tools(otomatis diganti, jangan tampilkan syntax mentah): {{tool:time}} {{tool:calc:EKSPRESI}} {{tool:xtal:nama}} {{tool:stat:nama}} {{tool:reply}} {{tool:stiker:PACK}}(sedih/ketawa/marah/mikir/bingung/nyesel/spam/lawak/keren/malu/curiga/gakpercaya/merasakeren){{tool:liststats:nama stat}}
